...
public class KeybindManager
{
	...
	public static KeyMapping callHorseRide;
	...
	public static void registerKeyBinding(RegisterKeyMappingsEvent event)
	{
		...
		callHorseRide = new KeyMapping("key.callhorse_ride.desc", GLFW.GLFW_KEY_B, "key.callablehorses.category");
