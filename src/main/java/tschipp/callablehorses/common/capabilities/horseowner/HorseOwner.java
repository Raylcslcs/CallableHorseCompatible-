...
public class HorseOwner implements IHorseOwner, ICapabilitySerializable<CompoundTag>, ICapabilityProvider
{
	...
	public LivingEntity createHorseEntity(Level world, boolean incrementHorseNum)
	{
		...
		if (type.isPresent())
		{
			...
			if (entity instanceof LivingEntity livingEntity && !(entity instanceof Player))
			{
				...
				if (livingEntity instanceof ICallableHorsesMountCallbacks callbacks)
					callbacks.callablehorses$afterLoadFromNBT();
	...
	public void setHorse(LivingEntity horse, Player player)
	{
		...
		cap.ifPresent(storedHorse -> {
			...
			CompoundTag tag = HorseHelper.sanitizeEntityNBT(horse.serializeNBT());
